...
//Possible values for the board.
   ...
   {WALL,PATH,PATH,PATH,PATH,PATH,PATH,PATH,PATH,_END,WALL},
   {WALL,PATH,WALL,WALL,WALL,WALL,WALL,WALL,WALL,WALL,WALL},  
   {WALL,PATH,PATH,PATH,PATH,PATH,WALL,PATH,PATH,PATH,WALL},  
   {WALL,WALL,WALL,WALL,WALL,PATH,WALL,PATH,WALL,PATH,WALL},   
   ...
   {WALL,PATH,WALL,WALL,WALL,WALL,WALL,WALL,WALL,WALL,WALL},   
   {WALL,PATH,PATH,PATH,PATH,PATH,PATH,PATH,PATH,STAR,WALL},
   {WALL,WALL,WALL,WALL,WALL,WALL,WALL,WALL,WALL,WALL,WALL}
   }; 
} 
